                        ...
                        CommandManager.literal("needs-rollback")
                            .then(
                                    ...
                                    .then(
                                        CommandManager.argument("rollback_server", StringArgumentType.string())
                                            .executes({ context ->
                                                ...
                                                try {
                                                    FabricGlobalContext.storageWrapper.updateAllPlayersRollbackStatus(
                                                        true,
                                                        rollbackServer
                                                    )
                                            ...
                                            .then(
                                                CommandManager.argument("players", EntityArgumentType.players())
                                                    .executes({ context ->
                                                        ...
                                                        try {
                                                            FabricGlobalContext.storageWrapper.updateRollbackStatus(
                                                                players,
                                                                true,
                                                                rollbackServer
                                                            )
                                ...
                                CommandManager.literal("disable").executes({ context ->
                                    try {
                                        FabricGlobalContext.storageWrapper.updateAllPlayersRollbackStatus(false, null)
                                        context.source.sendFeedback(
